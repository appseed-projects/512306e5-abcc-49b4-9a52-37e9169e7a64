...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-10 21:52`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/512306e5-abcc-49b4-9a52-37e9169e7a64.git
$ cd 512306e5-abcc-49b4-9a52-37e9169e7a64
```
